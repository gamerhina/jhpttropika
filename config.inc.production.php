...
base_url = "https://jhpttropika.fp.unila.ac.id"
...
driver = mysqli
host = localhost
username = u221684428_jhpttropika
password = "UrjZL6%HgtZ8fqLoV2T7G"
name = u221684428_jhpttropika
...
files_dir = /home/u221684428/domains/fp.unila.ac.id/jhpttropika_data/files
...
; stripped.
allowed_html = "a[href|target|title],em,strong,cite,code,ul,ol,li[class],dl,dt,dd,b,i,u,img[src|alt|width|height],sup,sub,br,p,div[class|id|style],iframe[src|width|height|frameborder|scrolling|seamless|allowfullscreen|style|title],span[class|style]"
...
smtp_auth = PLAIN
smtp_username = "jhpt.tropika@fp.unila.ac.id"
smtp_password = "bvzy thrh uzdx ofcb"
;
...
; default_envelope_sender = jhpt.tropika@fp.unila.ac.id
...
repository_id = jhpttropika.unila.ac.id
...
recaptcha_public_key = 6LcuHOorAAAAAHasjd_0UaCOQdQlLU33N2yrlQTB

; Private key for reCaptcha (see http://www.google.com/recaptcha)
recaptcha_private_key = 6LcuHOorAAAAAHw4VAmWvFKSs2a5GwzW017ZSbFj
