    ...
    public function __construct($action, $locales, $context, $imageUploadUrl)
    {
        ...
        $this->addGroup([
            ...
            ->addField(new FieldRichTextarea('editorialTeam', [
                ...
                'isMultilingual' => true,
                'groupId' => 'keyInfo',
                'toolbar' => 'bold italic superscript subscript | link | blockquote bullist numlist | image | code | template',
                'plugins' => 'paste,link,lists,image,code,template',
                'init' => [
                    'templates' => [
                        [
                            'title' => 'Editorial Team Member',
                            'description' => 'Template untuk menambahkan anggota editorial team beserta foto',
                            'content' => '<div class="group"><div class="editorial-list"><div class="img-profile"><div class="imgthumb"><img src="' . \APP\core\Application::get()->getRequest()->getBaseUrl() . '/public/site/images/jurnaladm/default_profil.png" alt="Profile Image" width="150" /></div></div><div class="team-content"><div class="team-aff"><strong><img class="ico-label" src="' . \APP\core\Application::get()->getRequest()->getBaseUrl() . '/public/site/images/jurnaladm/author1.png" />Nama Lengkap / Gelar</strong></div><div class="team-aff"><img class="ico-label" src="' . \APP\core\Application::get()->getRequest()->getBaseUrl() . '/public/site/images/jurnaladm/scopus1.jpg" />Scopus ID : <a href="#">000000000</a></div><div class="team-aff"><img class="ico-label" src="' . \APP\core\Application::get()->getRequest()->getBaseUrl() . '/public/site/images/jurnaladm/orcid1.jpg" /> <a href="#">https://orcid.org/0000-0000-0000-0000</a></div><div class="team-aff"><img class="ico-label" src="' . \APP\core\Application::get()->getRequest()->getBaseUrl() . '/public/site/images/jurnaladm/institusi.jpg" />Department / Faculty / University, Country</div></div></div></div>',
                        ]
                    ]
                ],
