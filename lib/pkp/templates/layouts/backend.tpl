...
<head>
	...
	<script type="text/javascript">
		// Custom styling for DOI management to match reference theme
		document.addEventListener("DOMContentLoaded", function() {
			var observer = new MutationObserver(function(mutations) {
				var badges = document.querySelectorAll('.pkpBadge');
				badges.forEach(function(b) {
					if (b.innerText.includes('Unregistered')) {
						b.style.setProperty('background-color', '#c10066', 'important');
						b.style.setProperty('border-color', '#c10066', 'important');
						b.style.setProperty('color', '#ffffff', 'important');
					} else if (b.innerText.includes('Registered') && !b.innerText.includes('Unregistered')) {
						b.style.setProperty('background-color', '#00678c', 'important');
						b.style.setProperty('border-color', '#00678c', 'important');
						b.style.setProperty('color', '#ffffff', 'important');
					}
				});
				var btns = document.querySelectorAll('.pkpButton');
				btns.forEach(function(btn) {
					if (btn.innerText.includes('Deposit All')) {
						btn.style.setProperty('background-color', '#00678c', 'important');
						btn.style.setProperty('border-color', '#00678c', 'important');
	...
	<link rel="stylesheet" href="{$baseUrl}/plugins/themes/modernthemebihi/styles/backend.style.css?v={$smarty.now}" type="text/css" />
</head>
