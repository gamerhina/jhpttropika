...
<div id="main-content" class="page page_register">
	...
	<form class="pkp_form register p-lg-5 mx-lg-5" id="register" method="post" action="{url op="register"}">
		{csrf}
		...
		<div class="buttons text-center mb-3">
			...
			<a class="btn btn-outline-success" href="{url page="login" source=$rolesProfileUrl}" class="login">
