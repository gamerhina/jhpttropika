...
<div id="main-content" class="page page_lost_password">
	...
	<form class="pkp_form lost_password p-lg-5 mx-lg-5" id="lostPasswordForm" action="{url page="login" op="requestResetPassword"}" method="post">
		{csrf}
		...
		<div class="buttons text-center mb-3">
			...
			{if !$disableUserReg}
				...
				<a class="btn btn-outline-success register-button" href="{$registerUrl}" role="button">
