...
<div id="main-content" class="page page_submissions">
	...
	{if $submissionChecklist}
		<div class="submission_checklist shadow-sm rounded p-3 mb-3">
	...
	{if $currentJournal->getLocalizedData('authorGuidelines')}
		<div class="author_guidelines shadow-sm rounded p-3 mb-3">
			<h3 class="page-body-header">
	...
	{if $currentJournal->getLocalizedData('copyrightNotice')}
		<div class="copyright-notice shadow-sm rounded p-3">
			<h3 class="page-body-header">
