...
<div  id="main-content" class="page page_search">
	...
	<div class="page-header">
		<h1 class="font-size-27">{translate key="common.search"}</h1>
	</div>

	{* Main Search From *}
	<form method="post" id="search-form" class="search-form p-lg-5 mx-lg-5" action="{url op="search"}" role="search">
		{csrf}
		...
		<div class="form-group mb-3">
			...
			<div class="input-group">
				...
				<span class="input-group-btn">
					<input type="submit" value="{translate key="common.search"}" class="btn btn-success rounded-end rounded-0">
				</span>
			</div>
		</div>

		<fieldset class="search-advanced mb-4">
			<legend>
