...
<a class="galley-link btn {if $isSupplementary}btn-dark{else}btn-success{/if} {$type} btn-sm w-100" role="button" href="{url|escape page=$page op="view" path=$parentId|to_array:$galley->getBestGalleyId($currentJournal)}">
