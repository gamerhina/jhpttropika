 ...
 *}
<div class="issue-summary media border-bottom mb-3 pb-3 row">
		...
		<div class="col-1">
			<div class="media-left">
				<a class="cover" href="{url|escape op="view" path=$issue->getBestIssueId($currentJournal)}">
					<img class="media-object img-thumbnail" src="{$issue->getLocalizedCoverImageUrl()|escape}" alt="{$issue->getLocalizedCoverImageAltText()|escape|default:''}">
				</a>
			</div>
		</div>
	{/if}
