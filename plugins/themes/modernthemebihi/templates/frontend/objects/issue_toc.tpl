...
<div class="issue-toc">
	...
	{* <div class="heading row mb-3">
		...
		{if $issueCover}
			{assign var="issueDetailsCol" value="7"}
			<div class="thumbnail col-md-5">
				<a class="cover" href="{url|escape op="view" page="issue" path=$issue->getBestIssueId()}">
					<img class="img-thumbnail" src="{$issueCover|escape}" alt="{$issue->getLocalizedCoverImageAltText()|escape|default:''}">
				</a>
			</div>
		{/if}
		...
		{foreach name=sections from=$publishedSubmissions item=section}
			<section class="section">
				{if $section.articles}
					...
					{/if}
					<div class="media-list shadow-sm p-3 rounded">
